...
class DegreesOfFreedom:
    ...
    def get_remodel_dofs(self, t_new, geo, cell_to_split_from):
        ...
        if geo.Cells[cell_to_split_from].AliveStatus == 0:
    ...
    def get_remeshing_dofs(self, geo, id_cells, interface_type):
        ...
        id_tnew_cells_no_debris = [cell_id for cell_id in id_cells if geo.Cells[cell_id].AliveStatus == 1]
        ...
        for num_cell, cell in enumerate(geo.Cells):
            ...
            if num_cell in id_tnew_cells_no_debris:
                ...
                for globalId in cell.globalIds[news]:
                    ...
                    self.remeshing[(dim * globalId): (dim * (globalId + 1)) - 1] = 1
